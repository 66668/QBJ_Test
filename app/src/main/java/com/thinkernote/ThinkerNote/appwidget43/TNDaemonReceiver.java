 ...
 * @since 2016-3-22
 */
public class TNDaemonReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        Log.d(TAG, "TNDaemonReceiver守护进程开启 " + intent.getAction());
        // Widget仅支持4.0+
        Intent service = new Intent();
        service.setClass(context, TNWidgetService.class);

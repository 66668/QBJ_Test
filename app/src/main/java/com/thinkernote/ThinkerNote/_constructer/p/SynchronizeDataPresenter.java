...
import com.thinkernote.ThinkerNote._constructer.m.SynchronizeDataModule;
 ...
 * 注册 p层 具体实现
 */
public class SynchronizeDataPresenter implements OnSynchronizeDataListener {
    private Context context;
    private OnSynchronizeDataListener onView;

    //p层调用M层方法
    private SynchronizeDataModule module;

    public SynchronizeDataPresenter(Context context, OnSynchronizeDataListener listener) {
        this.context = context;
        this.onView = listener;
        module = new SynchronizeDataModule(context);
    }

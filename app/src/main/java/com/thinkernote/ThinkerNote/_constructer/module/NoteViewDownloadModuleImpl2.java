 ...
 * 下载文件 m层 具体实现
 */
public class NoteViewDownloadModuleImpl2 implements INoteViewDownloadModule {

    private Context context;
    private static final String TAG = "SJY";
    private OnNoteViewDownloadListener listener;

    public NoteViewDownloadModuleImpl2(Context context, OnNoteViewDownloadListener listener) {

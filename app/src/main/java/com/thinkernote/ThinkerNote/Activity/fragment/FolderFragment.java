...
import com.thinkernote.ThinkerNote.views.PullToRefreshExpandableListView;
import com.thinkernote.ThinkerNote.views.PullToRefreshExpandableListView.OnRefreshListener;
 ...
 * 接口：同步
 */
public class FolderFragment extends TNChildViewBase implements
        OnRefreshListener, OnItemLongClickListener, OnChildClickListener, OnSyncListener {
